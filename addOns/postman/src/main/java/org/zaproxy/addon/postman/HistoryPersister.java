...
public class HistoryPersister {
    ...
    public void handleMessage(final HttpMessage message, int initiator) {
        ...
        if (message.getRequestHeader().getURI() == null) {
            System.out.println("URII ISS NOOT PRESENT here in history");
        }
        else {
            System.out.println("URII ISS HAII PRESENT here in history");
        }
        ...
        try {
            ...
            // Stats.incCounter(ExtensionPostman.URL_ADDED_STATS);
        } catch (Exception e) {
